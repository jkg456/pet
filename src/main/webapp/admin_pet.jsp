...
<%@ page import = "com.rain.bean.TypeBean,com.rain.dao.AdminDao,com.rain.dao.TypeDao,com.rain.bean.PetBean,com.rain.dao.PetDao,com.rain.bean.AdminBean" %>
<%@ page import="com.rain.bean.PetBean" %>
<%@ page import="com.rain.dao.PetDao" %>
...
%>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="collapse navbar-collapse main-navbar-collapse">
                        <a class="navbar-brand" href="/pro4/admin.jsp"><strong>欢迎使用宠物管理系统</strong></a>
        ...
        <div class="row">
            ...
            <div class="col-md-2 bootstrap-admin-col-left">
                <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
                    <li>
                        <a href="/pro4/admin_pet.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 宠物管理</a>
                    </li>
                    <li>
                        <a href="/pro4/admin_user.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 顾客管理</a>
                    </li>
                    <li>
                        <a href="/pro4/admin_pettype.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 宠物分类管理</a>
                    </li>
                    <li>
                        <a href="/pro4/admin_borrow.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 宠物寄养信息</a>
                    </li>
                    <li>
                        <a href="/pro4/admin_history.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 宠物归还信息</a>
                    </li>
                </ul>
                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                ...
                                <input type="hidden" name="tip" value="1">
                        			<div class="col-lg-7 form-group">
                                        <%--@declare id="query_bname"--%><label class="col-lg-4 control-label" for="query_bname">宠物名称</label>
                                        <div class="col-lg-8">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <button type="button" class="btn btn-primary" id="btn_add" data-toggle="modal" data-target="#addModal">添加宠物</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <!---在此插入信息-->
                             <%
                             ArrayList<PetBean> bookdata = new ArrayList<PetBean>();
                             bookdata = (ArrayList<PetBean>)request.getAttribute("data");
                           if(bookdata==null){
                        	   PetDao bookdao = new PetDao();
                        	   bookdata = (ArrayList<PetBean>)bookdao.get_ListInfo();
                           }
	
  							for (PetBean bean : bookdata){
  								%>
								<tbody>
	                         	   	<td><%= bean.getCard() %></td>
	                                <td><%= bean.getType() %></td>
									...
									<button type="bLutton" class="btn btn-danger btn-xs" onclick="deletePet(<%= bean.getBid() %>)">删除</button>
									</td>
                          	  </tbody>
                       <%} %>
                        </table>
    ...
    function deletePet(bid) {
    	con=confirm("是否删除?"); 
    	if(con==true){
    		location.href = "/pro4/deleteServlet?bid="+bid;
    	}
    }
    </script>
                                     ...
                                     <!-------------------------------------------------------------->  
                                        ...
                                        <!-- 修改模态框（Modal） -->
                               <form class="form-horizontal" method="post" action="/pro4/updatePetServlet">   <!--保证样式水平不混乱-->
									<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
										...
										<div class="form-group">
											<%--@declare id="firstname"--%><label for="firstname" class="col-sm-3 control-label">宠物号</label>
												<div class="col-sm-7">
												<input type="hidden" id="updateBookId" name="updatebid">
													<input type="text" class="form-control" id="updateISBN" name="card"  placeholder="请输入宠物号">
										 ...
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">宠物昵称</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updateBookName" name="name"  placeholder="请输入宠物昵称">
												<label class="control-label" for="updateBookName" style="display: none;"></label>
												</div>
										</div>
											
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">宠物类型</label>
											<div class="col-sm-7">
...
ArrayList<TypeBean> data = (ArrayList<TypeBean>)typedao.get_ListInfo();
  ...
  %>                 <option value="<%= bean.getName() %>"><%= bean.getName() %></option>                        <%} %>                                        
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">主人姓名</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updateAutho" name="autho" placeholder="请输入主人姓名">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">宠物性别</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updatePress" name="press"  placeholder="请输入宠物性别">
												<label class="control-label" for="updatePress" style="display: none;"></label>
												</div>
										</div>		
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">宠物年龄</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updateNum" name="num"  placeholder="请输入宠物年龄">
												<label class="control-label" for="updatePress" style="display: none;"></label>
												</div>
										</div>	
										</div>
     ...
     <!--------------------------------------添加的模糊框------------------------>  
                                 <form class="form-horizontal" method="post" action="/pro4/AddPetServlet">   <!--保证样式水平不混乱-->
                                        <!-- 模态框（Modal） -->
									<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										...
										<div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">宠物号</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="addISBN" required="required" name="card" placeholder="请输入宠物号">
										 ...
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">宠物昵称</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="addBookName" required="required" name="name"  placeholder="请输入宠物昵称">
  ...
  %>                 <option value="<%= bean.getName() %>"><%= bean.getName() %></option>                        <%} %>
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">主人姓名</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="addAutho" required="required" name="autho"  placeholder="请输入主人姓名">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">宠物性别</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="addPress" required="required" name="press"  placeholder="请输入宠物性别">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">宠物年龄</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="addNum" required="required" name="num" placeholder="请输入宠物年龄">
