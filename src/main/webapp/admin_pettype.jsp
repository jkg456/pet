...
<%@ page import = "com.rain.bean.TypeBean,com.rain.dao.AdminDao,com.rain.dao.TypeDao,com.rain.bean.TypeBean,com.rain.dao.PetDao,com.rain.bean.AdminBean" %>
...
<button type="button" class="btn btn-danger btn-xs" onclick="deletebook(<%= bean.getTid() %>)">删除</button>
    ...
    function deletebook(tid) {
    	con=confirm("是否删除?"); 
    	if(con==true){
    		location.href = "/pro4/deleteTypeServlet?tid="+tid;
    	}
    }
    </script>
                                     ...
                                     <!-------------------------------------------------------------->  
                                        ...
                                        <!-- 修改模态框（Modal） -->
                               <form class="form-horizontal" method="post" action="/pro4/updatePetTypeServlet">   <!--保证样式水平不混乱-->
										 ...
										 <div class="form-group">
											<%--@declare id="firstname"--%><label for="firstname" class="col-sm-3 control-label">宠物名称</label>
												...
												<%--@declare id="updatebookname"--%><input type="hidden" name="tid" id="updatetid">
													<input type="text" class="form-control" id="updatename" name="name"  placeholder="请输入宠物分类名称">
     ...
     <!--------------------------------------添加的模糊框------------------------>  
                                 <form class="form-horizontal" method="post" action="/pro4/AddPetTypeServlet">   <!--保证样式水平不混乱-->
                                        <!-- 模态框（Modal） -->
										...
										<!---------------------表单-------------------->
										 ...
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">分类名称</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="addBookName" required="required" name="name"  placeholder="请输入宠物分类名称">
