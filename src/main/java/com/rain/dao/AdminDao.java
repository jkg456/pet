...
/**
 * 有关顾客账号的连接数据库操作，登录验证，注册，修改账号，修改密码
 */
public class AdminDao {
	...
	/**
	 * 注册账号的函数，传入账号，密码，姓名，邮箱，手机号，寄养天数，可寄养数
	 * @param username
	 * @param password
	 * @param name
	 * @param email
	...
	/**
	 * 根据传入的账号，密码，来查找对应的顾客信息，返回一个AdminBean类型，
	 * @param username
	 * @param password
	 * @return
	 */
...
//			stm.setString(1,name);
	...
	/**
	 * 获取全部用户的信息，其中sql语句中的status=1，表示只查找顾客，不显示管理员的
	 * @return
	 */
	...
	/**
	 * 根据传入的aid，查找到对应的顾客的全部信息，返回一个AdminBean类型的数据
	 * @param aid
	 * @return
	 */
	...
	/**
	 * 根据传入的aid，查找到对应的顾客的全部信息，返回一个AdminBean类型的数据，与上一个相似，只是aid的类型为String，
	 * @param aid
	 * @return
	 */
