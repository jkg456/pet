                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">顾客管理</div>
                            </div>
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                <form class="form-horizontal" action="/pro4/selectServlet" method="post">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <button type="button" class="btn btn-primary" id="btn_add" data-toggle="modal" data-target="#addModal">添加顾客</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<button type="button" class="btn btn-danger btn-xs" onclick="deletebook(<%= bean.getAid() %>)">删除</button>
    ...
    function deletebook(aid) {
    	con=confirm("是否删除?"); 
    	if(con==true){
    		location.href = "/pro4/deleteUserServlet?aid="+aid;
    	}
    }
    </script>
                                     ...
                                     <!-------------------------------------------------------------->  
                                        ...
                                        <!-- 修改模态框（Modal） -->
                               <form class="form-horizontal" method="post" action="/pro4/updateUserServlet">   <!--保证样式水平不混乱-->
									<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">邮箱</label>
												<div class="col-sm-7">
													<%--@declare id="updateautho"--%><input type="text" class="form-control" id="updateemail" name="email" placeholder="">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">可寄养天数</label>
												<div class="col-sm-7">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">最大寄养数</label>
												<div class="col-sm-7">
     ...
     <!--------------------------------------添加的模糊框------------------------>  
                                 <form class="form-horizontal" method="post" action="/pro4/AddUserServlet">   <!--保证样式水平不混乱-->
                                        <!-- 模态框（Modal） -->
									<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">可寄养天数</label>
												<div class="col-sm-7">
													<%--@declare id="addnum"--%><input type="text" class="form-control" name="lend_num" id="updatelend_num" required="required"  placeholder="请输入可寄养天数">
												<label class="control-label" for="addNum" style="display: none;"></label>	
												</div>
										</div>
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">最大可寄养数</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" name="max_num" id="updatemax_num" required="required" placeholder="请输入最大可寄养数">
												<label class="control-label" for="addPress" style="display: none;"></label>	
												</div>
										</div>
