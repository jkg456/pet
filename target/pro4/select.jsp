...
<%@ page import = "com.rain.bean.AdminBean,com.rain.dao.AdminDao,com.rain.bean.PetBean,com.rain.dao.PetDao" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="collapse navbar-collapse main-navbar-collapse">
                    <a class="navbar-brand" href="/reader.jsp"><strong>欢迎使用宠物管理系统</strong></a>
...
<div class="container">
  ...
  %>                 
								<tbody>
	                                ...
	                                <td><%= bean.getPress() %></td>  
	                                <td><%= bean.getNum() %></td>
<td><button type="button" class="btn btn-info btn-xs" data-toggle="modal" onclick="borrowbook(<%= bean.getBid() %>)" >寄养</button>   	</td>
    ...
    function borrowbook(bid) {
    	con=confirm("是否寄养?");
    	if(con==true){
    		location.href = "/pro4/borrowServlet?tip=1&bid="+bid;
    	}
    }
    </script>
        </div>
