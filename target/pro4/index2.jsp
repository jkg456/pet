                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                           <a href="#" role="button" class="dropdown-toggle" data-hover="dropdown"> <i class="glyphicon glyphicon-user"></i> 欢迎您: 
                                <span><% out.print(admin.getName());%></span>  <i class="caret"></i></a><ul class="dropdown-menu">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">宠物查询</div>
                        </div>
                        <div class="bootstrap-admin-panel-content">
                            <ul>
                                <li>根据宠物编号、宠物昵称查询宠物信息</li>
                                <li>可查询宠物图书的编号、名称、种类、主人、年龄、寄养时间等</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <!-- 判断用户是否登录 -->
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">寄养信息</div>
                        </div>
                        <div class="bootstrap-admin-panel-content">
                            <ul>
                                <li>可查询除宠物的基本信息、寄养日期、领宠日期、超期天数等</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">寄养历史</div>
                        </div>
                        <div class="bootstrap-admin-panel-content">
                            <ul>
                                <li>查询自己以往的寄养历史，包括哪些宠物等具体信息</li>
                            </ul>
                        </div>
                    </div>
                </div>
