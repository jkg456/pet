...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <form class="bootstrap-admin-login-form" method="post" action="/pro4/LoginServlet" onsubmit="return validate()">
                 <% 
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="username" name="username" required="required" placeholder="帐号"/>
                ...
                <div class="form-group">
                    ...
                    <label class="control-label" for="password">没有账号请<a href="/pro4/register.jsp" style="color:blue;">注册</a></label>
                <br>
