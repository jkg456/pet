...
<%@ page import = "com.rain.bean.HistoryBean,com.rain.dao.AdminDao,com.rain.dao.TypeDao,com.rain.dao.PetDao,com.rain.bean.AdminBean" %>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">宠物寄养信息</div>
                            </div>
...
id="btn_update" onclick="haibook(<%= bean.getHid() %>)">领宠</button>
	</td>                                            
                          	  </tbody>
                       <%} %> 
                        </table>
    ...
    function haibook(hid) {
    	con=confirm("是否领宠?");
    	if(con==true){
    		location.href = "/pro4/borrowServlet?tip=2&show=2&hid="+hid;
    	}
    }
    </script>
                                     ...
                                     <!-------------------------------------------------------------->  
                                        ...
                                        <!-- 修改模态框（Modal） -->
                               <form class="form-horizontal" method="post" action="/pro4/updateBookServlet">   <!--保证样式水平不混乱-->
									<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
										...
										<!---------------------表单-------------------->
										 ...
										 <div class="form-group">
											<%--@declare id="firstname"--%><label for="firstname" class="col-sm-3 control-label">宠物名称</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updateBookName" name="name"  placeholder="请输入宠物名称">
     ...
     <!--------------------------------------添加的模糊框------------------------>  
                                 <form class="form-horizontal" method="post" action="/pro4/AddBookServlet">   <!--保证样式水平不混乱-->
                                        <!-- 模态框（Modal） -->
										...
										<!---------------------表单-------------------->
										 ...
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">分类名称</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="addBookName" required="required" name="name"  placeholder="请输入宠物名称">
